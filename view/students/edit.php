	...
	<div class="col-xl-12 col-lg-11">
	  <div class="card shadow mb-4">
		...
		<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
		  <h6 class="m-0 font-weight-bold text-gray-600"><span class="fas fa-fw fa-user-graduate fa-lg"></span> Edit Student Information</h6>
		</div>
		<!-- Card Body -->
		<div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            <label for="package-file-select" class="bg-gray-400 p-1"><p class="text-center mb-0 font-weight-bold">Student Photo</p><img src="<?php echo $this->getSiteUrl() ?>uploads/get_image.php?image=<?php echo $this->getret['data']['photo_path']; ?>" id="output" width="120" height="120" class="bg-gray-200"/></label>
