...
function getSideBar() {
	...
	$.ajax({
		...
		success: function(response) {
			...
			returnString = '<a class="sidebar-brand d-flex align-items-center justify-content-center header-bg" href="/"><div class="sidebar-brand-icon m-1"><i class="fas fa-database text-success"></i></div><div class="sidebar-brand-text mx-1 text-gray-200">Masterfile <sup class="text-gray-200">DB</sup></div></a>';
